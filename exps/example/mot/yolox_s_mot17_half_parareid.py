...
class Exp(MyExp):
    ...
    def get_model(self, settings=None):
        from yolox.models import YOLOPAFPN, YOLOX_ParaReID, YOLOXHead_ParaReID
        ...
        if getattr(self, "model", None) is None:
            ...
            head = YOLOXHead_ParaReID(self.num_classes, self.width, in_channels=in_channels, nID=nID)
            self.model = YOLOX_ParaReID(backbone, head)
